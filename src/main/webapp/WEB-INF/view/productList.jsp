<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.List,com.example.demo.dto.ProductResponse" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="container mt-4">
    ...
    <!-- Search form -->
    <form action="searchProduct" method="get" class="form-inline justify-content-center search-form">
        ...
        <div class="col-md-4 mb-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="addToCart?id=<%= product.getId() %>" class="btn btn-custom">Add to Cart</a>
